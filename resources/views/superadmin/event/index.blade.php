                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex">
                            ...
                            <a class="btn btn-sm btn-primary ml-auto" href="{{route('superadmin.events.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.event-btn-add') }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    @foreach ($events as $key=>$event)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="{{asset('public/assets/images/'.$event->image)}}" width="150" height="100" class="img-responsive rounded" alt="image">
                                                @endif
                                            ...
                                            <td class="text-center w-25">
                                                <a href="{{ route('superadmin.events.edit', $event->id) }}" class="btn btn-sm btn-info mt-1"><i class="nav-icon fas fa-edit"></i> Edit</a>

                                                <button type="button" class="btn btn-sm btn-danger mt-1" onclick="deleteEvent({{ $event->id }})"><i class="nav-icon fas fa-trash-alt"></i> Delete</button>
