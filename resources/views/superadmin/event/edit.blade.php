            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <form action="{{ route('superadmin.events.update', $events->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        @if (!empty($events['image']) && file_exists($path))
                            <div class="card-footer d-flex">
                                ...
                                <form id="delete-image-form-{{ $events->id }}" action="{{ route('superadmin.events.destroy_image', $events->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
                                        ...
                                        <div class="card mb-2 ">
                                            ...
                                            @if (!empty($image['image']) && file_exists($path))
                                                <div class="card-footer d-flex">
                                                    ...
                                                    <form id="delete-images-form-{{ $image->id }}" action="{{ route('superadmin.events.destroy_images', $image->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
