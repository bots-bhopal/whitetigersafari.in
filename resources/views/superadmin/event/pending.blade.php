                                    ...
                                    @foreach ($pendingEvent as $key=>$event)
                                        <tr>
                                            ...
                                            <td class="text-center w-25">
                                                <a href="{{ route('superadmin.events.edit', $event->id) }}" class="btn btn-sm btn-info mt-1"><i class="nav-icon fas fa-edit" style="margin-right: 5px;"></i>{{ __('panel.news-btn-edit') }}</a>
                                                ...
                                                <form id="delete-form-{{ $event->id }}" action="{{ route('superadmin.events.destroy', $event->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
