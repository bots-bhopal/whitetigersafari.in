                ...
                <!-- Profile Image -->
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center" style="font-weight: 600;">{{ $user->name }}</h3>
                            <h6 class="text-center" style="font-weight: 500;">{{ $user->email }}</h6>

                            <p class="text-muted text-center">{{ $user->profession }}</p>

                            <form action="{{ route('superadmin.updateadminpassword', $user->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
