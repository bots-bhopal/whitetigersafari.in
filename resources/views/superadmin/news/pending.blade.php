                                    ...
                                    @foreach ($pendingNews as $key=>$news)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <img src="{{asset('public/assets/images/'.$news->image)}}" width="150" height="100" class="img-responsive rounded" alt="image">
                                                @endif
                                            ...
                                            <td class="text-center w-25">
                                                <a href="{{ route('superadmin.newses.edit', $news->id) }}" class="btn btn-sm btn-info mt-1"><i class="nav-icon fas fa-edit" style="margin-right: 5px;"></i>{{ __('panel.news-btn-edit') }}</a>
                                                ...
                                                <form id="delete-form-{{ $news->id }}" action="{{ route('superadmin.newses.destroy', $news->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
