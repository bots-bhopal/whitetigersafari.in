                                ...
                                <tbody>
                                    @foreach($pendingTender as $key=>$tender)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('superadmin.tender.edit', $tender->id) }}" class="btn btn-sm btn-primary mt-1" data-toggle="tooltip" data-placement="top" title="Edit" style="font-size: 14px; font-weight: 500;"><i class="far fa-edit"></i> Edit</a>
                                                ...
                                                <form id="delete-form-{{ $tender->id }}" action="{{ route('superadmin.tender.destroy', $tender->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

                                                <a href="{{ route('btr.tender.download', $tender->original_filename) }}" class="btn btn-sm btn-success mt-1" data-toggle="tooltip" data-placement="top" title="Download" style="font-size: 14px; font-weight: 500;"><i class="fa fa-download"></i> Download</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
