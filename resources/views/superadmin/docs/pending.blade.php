                                ...
                                <thead>
                                    ...
                                    @foreach($pendingDocument as $key => $document)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('superadmin.document.edit', $document->id) }}" class="btn btn-sm btn-primary"><i class="far fa-edit" style="margin-right: 5px;"></i>Edit</a>
                                                ...
                                                <form id="delete-form-{{ $document->id }}" action="{{ route('superadmin.document.destroy', $document->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

                                                <a href="{{ route('vvnp.docs.download', $document->original_filename) }}" class="btn btn-sm btn-success"><i class="fa fa-download" style="margin-right: 4px;"></i>Download</a>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
