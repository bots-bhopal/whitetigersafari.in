                            ...
                            <div class="row">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-warning">
                                        ...
                                        <a href="{{ route('superadmin.newses.index') }}" class="small-box-footer">{{ __('panel.dash-view-news') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        ...
                                        <a href="{{ route('superadmin.newses.pending') }}" class="small-box-footer">{{ __('panel.dash-view-news') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        ...
                                        <a href="{{ route('superadmin.tender.index') }}" class="small-box-footer">{{ __('panel.dash-view-tenders') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div> --}}
                                <!-- ./col -->
                                ...
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        ...
                                        <a href="{{ route('superadmin.tender.pending') }}" class="small-box-footer">{{ __('panel.dash-view-tenders') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div> --}}
                                <!-- ./col -->
                                ...
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-info">
                                        ...
                                        <a href="{{ route('superadmin.document.index') }}" class="small-box-footer">{{ __('panel.dash-view-documents') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div> --}}
                                <!-- ./col -->
                                ...
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        ...
                                        <a href="{{ route('superadmin.document.pending') }}" class="small-box-footer">{{ __('panel.dash-view-documents') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div> --}}
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        ...
                                        <a href="{{ route('superadmin.images.index') }}" class="small-box-footer">{{ __('panel.dash-view-gallery') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        ...
                                        <a href="{{ route('superadmin.images.pending') }}" class="small-box-footer">{{ __('panel.dash-view-gallery') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-primary">
                                        ...
                                        <a href="{{ route('superadmin.events.index') }}" class="small-box-footer">{{ __('panel.dash-view-event') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-light">
                                        ...
                                        <a href="{{ route('superadmin.events.pending') }}" class="small-box-footer">{{ __('panel.dash-view-gallery') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                            </div>
                                        ...
                                        <table id="tblUser" class="table table-bordered table-striped">
                                            ...
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('superadmin.editUserRole', $user->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                        <a href="{{ route('superadmin.changeadminpassword', $user->id) }}" class="btn btn-sm btn-warning">Change Password</a>
                                                        <button type="button" class="btn btn-sm btn-danger" onclick="deleteUser({{ $user->id }})">Delete</button>
                                                        <form id="delete-form-{{ $user->id }}" action="{{ route('superadmin.deleteUserRole', $user->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </td>
