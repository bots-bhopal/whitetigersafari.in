            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="card card-success card-outline">
                        ...
                        <form action="{{ route('serveradmin.newses.update', $newses->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        @if (!empty($newses['image']) && file_exists($path))
                            <div class="card-footer d-flex">
                                ...
                                <form id="delete-form-{{ $newses->id }}" action="{{ route('serveradmin.newses.destroy_image', $newses->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
                                        ...
                                        <div class="card mb-2 ">
                                            ...
                                            @if (!empty($image['image']) && file_exists($path))
                                                <div class="card-footer d-flex">
                                                    ...
                                                    <form id="delete-form-{{ $image->id }}" action="{{ route('serveradmin.newses.destroy_images', $image->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
