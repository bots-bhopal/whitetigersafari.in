                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header d-flex">
                                    <h3 class="card-title my-auto" style="font-size: 18px; font-weight: 600;">
                                        {{ __('panel.gallery-h1') }}
                                        <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="Total Number of Images" style="font-size: 14px; font-weight: 500;">{{ $images->count() }}</span>
                                    </h3>
                                    <a class="btn btn-sm btn-success ml-auto" href="{{route('serveradmin.images.create')}}"><i class="nav-icon fas fa-upload" style="margin-right: 5px;"></i>{{ __('panel.btn-upload') }}</a>
                                    <a class="btn btn-sm btn-primary mr-0 ml-1" href="{{route('serveradmin.images.show')}}"><i class="nav-icon fas fa-th-large" style="margin-right: 5px;"></i>{{ __('panel.btn-thumbnail') }}</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            @forelse ($images as $key=>$image)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <form id="delete-form-{{ $image->id }}" action="{{ route('serveradmin.images.destroy', $image->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </td>
