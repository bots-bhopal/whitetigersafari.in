                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex">
                            ...
                            <a class="btn btn-sm btn-primary ml-auto" href="{{route('serveradmin.document.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.document-btn-add') }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
