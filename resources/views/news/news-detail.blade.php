                        ...
                        <div class="zooks-promos-area">
                            @if ($newses)
                                <div class="image-block total-promos-area">
                                    @foreach($newses->images as $news)
                                    <div class="single-promos">
                                        <div class="image-box">
                                            <figure class="image">
                                                <img src="{{asset('public/storage/news_images/'. $news->image)}}" class="lazy-image owl-lazy" alt="">
                                                <div class="overlay-box">
                                                    <ul class="option-box">
                                                        <li><a href="{{asset('public/storage/news_images/'. $news->image)}}" class="lightbox-image" data-fancybox="image"><span class="fa fa-search"></span></a></li>
                                                    </ul>
                                                </div>
                                            </figure>
                                        </div>
