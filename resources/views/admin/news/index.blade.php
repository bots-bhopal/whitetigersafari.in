                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex">
                            ...
                            <a class="btn btn-sm btn-primary ml-auto" href="{{route('admin.newses.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.news-btn-add') }}</a>
                                    ...
                                    @foreach ($newses as $key=>$news)
                                        <tr>
                                            ...
                                            <td class="text-center w-25">
                                                <a href="{{ route('admin.newses.edit', $news->id) }}" class="btn btn-sm btn-info mt-1"><i class="nav-icon fas fa-edit" style="margin-right: 5px;"></i>{{ __('panel.news-btn-edit') }}</a>
                                                ...
                                                <form id="delete-form-{{ $news->id }}" action="{{ route('admin.newses.destroy', $news->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
