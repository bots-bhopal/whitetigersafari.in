                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header d-flex">
                                    ...
                                    <a class="btn btn-sm btn-success ml-auto" href="{{route('admin.images.create')}}"><i class="nav-icon fas fa-upload" style="margin-right: 5px;"></i>{{ __('panel.btn-upload') }}</a>
                                    <a class="btn btn-sm btn-primary mr-0 ml-1" href="{{route('admin.images.show')}}"><i class="nav-icon fas fa-th-large" style="margin-right: 5px;"></i>{{ __('panel.btn-thumbnail') }}</a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            @forelse ($images as $key=>$image)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <form id="delete-form-{{ $image->id }}" action="{{ route('admin.images.destroy', $image->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
                                                    </td>
