                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex">
                            ...
                            <a class="btn btn-sm btn-primary ml-auto" href="{{route('admin.document.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>{{ __('panel.document-btn-add') }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    @foreach($documents as $key => $document)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.document.edit', $document->id) }}" class="btn btn-sm btn-primary"><i class="far fa-edit" style="margin-right: 5px;"></i>Edit</a>
                                                ...
                                                <a href="{{ route('str.docs.download', $document->original_filename) }}" class="btn btn-sm btn-success"><i class="fa fa-download" style="margin-right: 4px;"></i>Download</a>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
